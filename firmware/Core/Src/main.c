...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, READ_OK_Pin|READ_FAIL_Pin|RFID_RST_Pin|ETH_NSS_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : READ_OK_Pin READ_FAIL_Pin */
  GPIO_InitStruct.Pin = READ_OK_Pin|READ_FAIL_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : RFID_RST_Pin ETH_NSS_Pin */
  GPIO_InitStruct.Pin = RFID_RST_Pin|ETH_NSS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
